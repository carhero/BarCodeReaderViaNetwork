...
extern int tcpsock;
extern BOOL IsTcpAvailable;

@interface MTBAdvancedExampleViewController () <UITableViewDataSource>
...
@property (nonatomic, strong) NSMutableArray *uniqueCodes;  //yhcha added to compare do not write again same unique code
...
- (void)TCPSendData
{
    ...
    send(tcpsock,sendMsg, strlen(sendMsg), 0);
}
